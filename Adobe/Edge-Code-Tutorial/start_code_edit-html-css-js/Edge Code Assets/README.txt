READ ME
Licensing and Installation of Sample Files for Edge Code CC Preview.
...
Simply unzip the files to the desired location. The "Start" folder contains the files to work with through the tutorials. The "Finish" folder contains the completed files after the tutorial is finished.
